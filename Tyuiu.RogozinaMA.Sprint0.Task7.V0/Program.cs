...
using Tyuiu.RogozinaMA.Sprint0.Task7.V0.Lib;

namespace Tyuiu.RogozinaMA.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнила: Рогозина М.А. | ИСПб-25-1";
            ...
            Console.WriteLine("* суммирует значения двух одномерных массивов по длине.*");
            Console.WriteLine("********************************************************");
